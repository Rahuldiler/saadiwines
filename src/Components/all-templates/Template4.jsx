...
function Template4({ templateData, staticTemplateData }){
    ...
    return(
            ...
            >
                ...
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-4 text-white  w-max ">
                    <div className="relative  px-3 lg:px-16 py-20">
                        ...
                        <div className="absolute -top-[35px] right-0 max-w-[45%]"><img src="/assets/templete/4/sliderImages/shape3.png" alt="" className="  "/></div>
                        <div className="absolute -bottom-[35px] left-0 max-w-[45%]"><img src="/assets/templete/4/sliderImages/shape4.png" alt="" className="  "/></div>
        ...
        <div className="grid lg:grid-cols-4 grid-cols-1 mt-20 max-w-7xl mx-auto gap-y-5 lg:gap-y-0">
          <div className="col-span-1 flex items-center mb-20 lg:mb-0">
            <div className="lg:text-right text-center my-auto">
              <img src="/assets/templete/4/coupleinfo/cople-man.jpg" alt="" className="rounded-full mb-3 lg:mx-0 lg:ml-auto mx-auto"/>
          ...
          <img src="/assets/templete/4/coupleinfo/couple-image.jpg" alt="" className="rounded-full !max-w-[85%] lg:!max-w-full object-cover mx-auto"/>
          <img src="/assets/templete/4/coupleinfo/fram-shape.png" alt="" className=" absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 lg:!w-[35rem] lg:!h-[46rem] w-[26rem] h-[34rem] !max-w-none"/>
          </div>
          <div className="col-span-1 flex items-center">
          <div className="lg:text-left text-center my-auto">
            <img src="/assets/templete/4/coupleinfo/couple-woment.jpg" alt="" className="lg:mb-3 mx-auto rounded-full lg:mx-0"/>
        ...
        <div className="text-center mb-20">
            <p><img src="/assets/templete/4/section-title2.png" alt="" className="mx-auto w-64"/></p>
        ...
        <div className="text-center mb-20">
          ...
          {templateData?.itinerary?.map((steps, index) => (
              <div key={index} className={`border-[2px] p-5 relative`}>
                ...
                />
                <img src="/assets/templete/4/Itinerary/event-shape-1.png" alt="" className="absolute px-3 -top-[15px] -right-[5px] bg-white"/>
                <img src="/assets/templete/4/Itinerary/event-shape-2.png" alt="" className="absolute px-3 -bottom-[15px] -left-[5px] bg-white"/>
              </div>
            ))}
            </div>
        </div>
