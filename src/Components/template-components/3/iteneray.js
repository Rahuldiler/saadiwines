...
function Itinerary({step,fctnName,fctnInfo,dateTime,location,img}) {
    return(
        ...
        <div className='mt-4 lg:mt-0'>
            <p className='!font-lora !text-[25px] mb-3 '>{fctnName} <span className='bg-[#9CAB8D] text-white px-3 py-1 text-base'><a href={location}>map</a></span> </p>
