...
function CoupleInfo({bgImage,name,gender,infotext1,infotext2,father,mother,grandfather,grandmother}) {
    return(
        ...
        <div className='py-[50px] lg:py-[100px] lg:px-[80px] lg:w-[80%] m-auto text-center mb-4' style={{backgroundImage: `url('${bgImage}')`,}}>
          <p className='!font-Alex !text-[50px] text-center'>{name}</p>
          {/* <p className='mb-4'>{gender}</p> */}
          <p className='mb-2'>{gender==="THE GROOM"?"s/o":"d/o"} Mr. {father} and Mrs. {mother}</p>
          <p className='mb-8'>{gender==="THE GROOM"?"g/s":"g/d"} Mr. {grandfather} and Mrs. {grandmother}</p>
