...
function Double({img,title,subtitle,infotext,imgPostion,bgColor,hoverTitle,hoverText}) {
    return(
        <div className='grid  lg:grid-cols-2 grid-rows-2 lg:grid-rows-none'>
            ...
            <div className="absolute top-0 left-0  opacity-100 mix-blend-multiply  w-[100%] h-[100%] bg-cover bg-no-repeat bg-[center_top]" style={{backgroundImage: "url('/images/bg-watercolor.jpg')",}}></div>
