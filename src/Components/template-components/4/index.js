    ...
    <div>
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-4 text-white  w-max ">
              <div className="relative  px-3 lg:px-16 py-20">
                ...
                <div className="absolute -top-[35px] right-0 max-w-[45%]">
                  <img
                    src="/assets/template4/sliderImages/shape3.png"
                    alt=""
                    className="  "
                  />
                </div>
                <div className="absolute -bottom-[35px] left-0 max-w-[45%]">
                  <img
                    src="/assets/template4/sliderImages/shape4.png"
                    alt=""
                    className="  "
                  />
                </div>
      ...
      <div className="grid lg:grid-cols-4 grid-cols-1 mt-20 max-w-7xl mx-auto gap-y-5 lg:gap-y-0">
        <div className="col-span-1 flex items-center mb-20 lg:mb-0">
          <div className="lg:text-right text-center my-auto">
            <img
              src="/assets/template4/coupleinfo/cople-man.jpg"
              alt=""
        ...
        <div className="col-span-2 relative mx-auto mb-20 lg:mb-0">
          <img
            src="/assets/template4/coupleinfo/couple-image.jpg"
            alt=""
            className="rounded-full !max-w-[85%] lg:!max-w-full object-cover mx-auto"
          />
          <img
            src="/assets/template4/coupleinfo/fram-shape.png"
            alt=""
        ...
        <div className="col-span-1 flex items-center">
          <div className="lg:text-left text-center my-auto">
            <img
              src="/assets/template4/coupleinfo/couple-woment.jpg"
              alt=""
      ...
      <div className="mt-24">
        <div className="text-center mb-20">
          <p>
            <img
              src="/assets/template4/section-title2.png"
              alt=""
              className="mx-auto w-64"
            />
          </p>
          <p className="!text-[40px] !font-medium !text-[#002642] !font-Futura mt-5">
            OUR LOVE STORY
          </p>
      ...
      <div className="my-24">
        <div className="text-center mb-20">
          ...
          <p className="!text-[40px] !font-medium !text-[#002642] !font-Futura mt-5 uppercase">
            Itinerary
          </p>
          <div className="relative">
            <div className="min-w-[140px]  h-[2px] border-b-[1px] absolute top-1/2 left-[51%] transform bg-[#86a0b6] -translate-y-1/2"></div>
        ...
        <div className="grid lg:grid-cols-4 grid-cols-1 max-w-[90rem] mx-auto text-center  gap-10 ">
          {templateData?.itinerary?.map((steps, index) => (
            <div key={index} className={`border-[2px] p-5 relative`}>
              ...
              />
              <img
                src="/assets/template4/Itinerary/event-shape-1.png"
                alt=""
                className="absolute px-3 -top-[15px] -right-[5px] bg-white"
              />
              <img
                src="/assets/template4/Itinerary/event-shape-2.png"
                alt=""
      ...
      <div className="my-24">
        ...
        <div className="lg:grid lg:grid-cols-4 max-w-[90rem] mx-auto text-center  gap-10 ">
          {templateData?.familyMembers?.map((steps, index) => (
            <div key={index} className={`border-[2px] p-5 relative`}>
              <FamilyCards name={steps.name} relation={steps.relation} />
              <img
                src="/assets/template4/Itinerary/event-shape-1.png"
                alt=""
                className="absolute px-3 -top-[15px] -right-[5px] bg-white"
