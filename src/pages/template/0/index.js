...
function Template0({ formData, templateId, color }) {
  ...
  return (
    <div className="lg:min-w-[1280px] ">
      ...
      <GreenStrip
        ...
        weddingDayURL={staticTemplateData[0].weddingDayURL}
        waterColorIMG={staticTemplateData[0].waterColorIMG}
        swiperSlide1={staticTemplateData[0].swiperSlide1}
        swiperSlide2={staticTemplateData[0].swiperSlide2}
        swiperSlide3={staticTemplateData[0].swiperSlide3}
        swiperSlide4={staticTemplateData[0].swiperSlide4}
        swiperSlide5={staticTemplateData[0].swiperSlide5}
        swiperSlide6={staticTemplateData[0].swiperSlide6}
      />

      {templateData && (
        <div
          className={`lg:p-24 py-28 p-4 lg:flex justify-between  `}
          style={{ backgroundImage: staticTemplateData[0].paral02 }}
        >
          <CoupleInfo
            bgImage={staticTemplateData[0].waterColor02c21919}
          ...
          <CoupleInfo
            bgImage={staticTemplateData[0].waterColorc21919}
      ...
      {templateData?.milestone?.map((milestone, index) => {
        return (
          <Double
            waterColor={staticTemplateData[0].waterColorc21919}
            key={index}
            img={staticTemplateData[1].double1}
      ...
      <div>
        ...
        <div className="grid lg:grid-cols-2  lg:px-20 py-14">
          <div className="px-8">
            <img src={staticTemplateData[0].double2} alt="" className="" />
      ...
      <div style={{ backgroundImage: staticTemplateData[0].waterColor02c21919 }}>
        ...
        >
          {templateData?.familyMembers?.map((cards, index) => (
            <Cards
              key={index}
              imgSrc={staticTemplateData[0].gallery10}
              name={cards.name}
      ...
      <div style={{backgroundColor : themeColor}} className={`bg-[${themeColor}] text-white relative`}>
        <div
          className="absolute top-0 left-0  opacity-100 mix-blend-multiply  w-[100%] h-[100%] bg-cover bg-no-repeat bg-[center_top]"
          style={{ backgroundImage: staticTemplateData[0].waterColorc21919 }}
        />
      ...
      {rsvp && (
        <div
          ...
          style={{ backgroundImage: staticTemplateData[0].paral03 }}
        >
          ...
          <div
            ...
            style={{ backgroundImage: staticTemplateData[0].waterColor02c21919 }}
          >
            <p>R.S.V.P</p>
      ...
      >
        <span
          ...
          style={{ backgroundImage: staticTemplateData[0].leaf03 }}
        ></span>
